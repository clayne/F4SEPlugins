...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00DA37C0);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady

// 936C94CC97C598DFE8A81979F95A75088F8B44C2+3AF
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x00820130);
...
void Hooks_GameData_Commit()
{
	...
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02D790C8 + 8); 
